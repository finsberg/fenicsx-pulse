...
#
# Here we impose that behaviour with a fitted multiplier. Biophysical cross-bridge
# models such as {cite}`land2017model` or {cite}`lewalle2024cardiac` instead let it
# emerge from their own kinetics -- see the
# [cross-bridge demos](README.md) for that comparison.
#
