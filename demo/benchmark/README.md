...
Deflection of a beam made of anisotropic material under a pressure load. This problem tests the implementation of the transversely isotropic constitutive law (Guccione model {cite}`guccione1991passive`) and the handling of Neumann boundary conditions (pressure).
